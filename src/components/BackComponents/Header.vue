<template>
  <div class="relative flex justify-between items-center bg-blue-400 h-16">
    ...
    <div class="relative mr-12">
      ...
      <!-- Dropdown menu -->
      <div v-if="$isDropdownOpen" id="dropdownAvatar" class="absolute z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-28 right-0 mt-4">
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownUserAvatarButton">
          <li>
            <a href="#" class="flex px-4 py-2 hover:bg-gray-100">
              <svg class="w-4 h-4 mt-[2px] mr-1 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <li>
            <a href="/alterpassword" class="flex px-4 py-2 hover:bg-gray-100">
              <svg class="w-4 h-4 mt-[2px] mr-1 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
