      ...
      <div class="container p-3">
        <div class="row-auto">
          ...
          <div class="row-span-1">
            ...
            >
              <a-form-item
                  :rules="[{ required: true, message: '组织用户名不能为空' }]"
                  label="组织用户名"
                  name="username"
              >
              ...
              <a-form-item
                  ...
                  name="organize"
              >
                <a-input v-model:value="organizeRegisterForm.organize">
                  <template #prefix>
              ...
              <a-form-item
                  :rules="[{ required: true, message: '请输入组织邮箱' }]"
                  label="组织邮箱"
                  name="email"
              >
              ...
              <a-form-item
                  ...
                  name="invite"
              >
                <a-input v-model:value="organizeRegisterForm.invite">
                  <template #prefix>
                    <UsergroupAddOutlined class="site-form-item-icon"/>
                  </template>
                </a-input>
              </a-form-item>
              <a-form-item
